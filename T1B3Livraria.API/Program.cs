...
using T1B3Livraria.Application.Services;
using T1B3Livraria.Domain.Interfaces;
using T1B3Livraria.Infrastructure.Context;
using T1B3Livraria.Infrastructure.Identity;
using T1B3Livraria.Infrastructure.Repositories;
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo
    {
        Title = "Livros API",
        Version = "v1",
        Description = "API REST do sistema Libraria T1B3 — Catálogo de Livros para ensino de ASP.NET Core"
    });
});
